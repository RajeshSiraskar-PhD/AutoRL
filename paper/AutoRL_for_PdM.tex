% AutoRL for Predictive Maintenance (LaTeX)
% Source artefacts: UM_Background.md, UM_Literature_Review.md, code/, figures and reports/
...
\begin{figure}[t]
	...
	\begin{subfigure}[t]{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{\detokenize{figures and reports/SIT_Results/_Analysis_Report_SIT_Set-1.jpg}}
		\caption{SIT Set-1}
		\label{fig:analysis_sit1}
	\end{subfigure}
	\begin{subfigure}[t]{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{\detokenize{figures and reports/SIT_Results/_Analysis_Report_SIT_Set-2.jpg}}
		\caption{SIT Set-2}
		\label{fig:analysis_sit2}
	\end{subfigure}
	\begin{subfigure}[t]{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{\detokenize{figures and reports/IEEE_Results/_Analysis_Report_IEEE.jpg}}
		\caption{IEEE}
...
\begin{figure}[t]
	...
	\begin{subfigure}[t]{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{\detokenize{figures and reports/SIT_Results/_Heatmap_SIT_Set-1.jpg}}
		\caption{SIT Set-1}
	\end{subfigure}
	\begin{subfigure}[t]{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{\detokenize{figures and reports/SIT_Results/_Heatmap_SIT_Set-2.jpg}}
		\caption{SIT Set-2}
	\end{subfigure}
	\begin{subfigure}[t]{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{\detokenize{figures and reports/IEEE_Results/_Heatmap_IEEE.jpg}}
		\caption{IEEE}
	\end{subfigure}
...
\begin{table}[t]
	...
	\label{tab:hyp_tests}
	\input{tables/hypothesis_tests_summary.tex}
\end{table}
...
\begin{table}[t]
	...
	\input{tables/ieee_unseen_summary.tex}
\end{table}
...
\begin{table}[t]
	...
	\input{tables/ieee_best_attention_per_algo.tex}
\end{table}
...
\begin{figure}[t]
	...
	\begin{subfigure}[t]{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{\detokenize{figures and reports/SIT_Results/_Statistical_p-value_SIT_Set-1.jpg}}
		\caption{SIT Set-1}
	\end{subfigure}
	\begin{subfigure}[t]{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{\detokenize{figures and reports/SIT_Results/_Statistical_p-value_SIT_Set-2.jpg}}
		\caption{SIT Set-2}
	\end{subfigure}
	\begin{subfigure}[t]{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{\detokenize{figures and reports/IEEE_Results/_Statistical_p-value_IEEE.jpg}}
		\caption{IEEE}
	\end{subfigure}
...
\begin{figure}[t]
	...
	\begin{subfigure}[t]{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{\detokenize{figures and reports/SIT_Results/_Statistical_t_SIT_Set-1.jpg}}
		\caption{SIT Set-1}
	\end{subfigure}
	\begin{subfigure}[t]{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{\detokenize{figures and reports/SIT_Results/_Statistical_t_SIT_Set-2.jpg}}
		\caption{SIT Set-2}
	\end{subfigure}
	\begin{subfigure}[t]{0.32\linewidth}
		\centering
		\includegraphics[width=\linewidth]{\detokenize{figures and reports/IEEE_Results/_Statistical_t_IEEE.jpg}}
		\caption{IEEE}
	\end{subfigure}
