...
5. Background
   ...
   - Empirical research ref.
   - Show how different the tool-wear plots are - ALL
   - Show how different the features are - Sample
   - Show how AutoRL gives best params for PPO
   - AutoRL:
	- What settings for PPO etc
        - Then create indivdual models
        - Then do testing
   - Robust scientific tests: t-test, p-test 95%
   - 

6. LaTeX
   - Instructions for figures: 'Create sample 4x4 plots' or 6x4 per page etc.
   - Create tables with ref to this image
